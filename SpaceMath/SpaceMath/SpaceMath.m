...
If[ Global`$SpaceMathStartupMessages =!= False,
	Print[	Style["SpaceMath ", "Text", Bold], Style[$SpaceMathVersion <> ". For help, use the ",
				"Text"],
			Style[DisplayForm@ButtonBox["documentation center", BaseStyle->"Link", ButtonData :> "paclet:SpaceMath/tutorial/Index",
				ButtonNote -> "paclet:SpaceMath/tutorial/Index"], "Text"],
