...
(*********************************************************Begin OF Kappa-Z************************************************************************************)
(******************************************************************************************************************************************************)
KZ1sigXHE::usage = "KZ1sigX"
KZ2sigXHE::usage = "KZ2sigX"
dataZZ1sigXYHE::usage = "dataZZ1sigXY"
dataZZ2sigXYHE::usage = "dataZZ2sigXY"
dataZZ1sigXYZHE::usage = "dataZZ1sigXYZ"
dataZZ2sigXYZHE::usage = "dataZZ2sigXYZ"
tableZ1sigXYHE::usage = "tableZ1sigXY"
tableZ2sigXYHE::usage = "tableZ2sigXY"
tableZ1sigXYZHE::usage = "tableZ1sigXYZ"
tableZ2sigXYZHE::usage = "tableZ2sigXYZ"
kappaz2sigHE::usage = "kappaz2sig"
...
KZHE::usage="KZ[ghzz_,x_,y_,xmin_,xmax_,ymin_,ymax_,xlabel_,ylabel_,xfor_,yfor_,xformin_,xformax_,xforstep_,yformin_,yformax_,yforstep_,PP_]\[Rule] This command evaluates \!\(\*SubscriptBox[\(\[Kappa]\), \(Z\)]\), \
...
TableKZHE::usage="TableKZ[ghzz_, x_, xmin_, xmax_, xstep_, y_, ymin_, ymax_, ystep_]\[Rule] This command generates a table of \!\(\*SubscriptBox[\(\[Kappa]\), \(Z\)]\). The argument ghzz is the hZZ, \
coupling. Here, h represents to SM-like Higgs boson while Z is the Z gauge boson. Labels x and y \
indicate the parameters to constraint, while xmin (ymin) and xmax (ymax) are the \
...
Export[
FileNameJoin[{$UserDocumentsDirectory,"TableKZone_1sigmaHE.txt"}],Re[dataZZ1sigXYHE[ghZZ,x,xmin,xmax,xstep]]/. {{_,0} -> Sequence[]},
"Table"
],
Export[
FileNameJoin[{$UserDocumentsDirectory,"TableKZone_2sigmaHE.txt"}],Re[dataZZ2sigXYHE[ghZZ,x,xmin,xmax,xstep]]/. {{_,0} -> Sequence[]},
"Table"
]
}
...
TableKZHE[ghZZ_, x_, xmin_, xmax_, xstep_, y_, ymin_, ymax_, 
  ystep_] := {
  Export[
   FileNameJoin[{$UserDocumentsDirectory, "TableKZ_1sigmaHE.txt"}],
   Re[
  ...
  ,
  Export[
   FileNameJoin[{$UserDocumentsDirectory, "TableKZ_2sigmaHE.txt"}],
   Re[
