...
AspectRatio->1,Filling->{3->{2}},FillingStyle->{RGBColor["#6B1F1B"],Opacity[0.5]}
]
...
(* AxesLabel -> {Style["x", Larger, Bold], 
 ...
 FrameStyle ->  Thickness[0.004], LabelStyle -> 35, ImageSize -> 800,
  GridLines -> Automatic, GridLinesStyle -> 
   Directive[Black, 
     Dashed], BoundaryStyle -> {1 -> Directive[Yellow, Dashed, Thickness[0.003]]}, PlotStyle -> {RGBColor["#6B1F1B"],Opacity[0.5]}, AspectRatio->1]
